...
static uint8_t s_conn_bssid[6]; /* Current wifi sta connected to AP MAC */
static uint8_t s_conn_ssid[WIFI_SSID_MAX_LEN] = {0}; /* Current wifi sta connected to AP channel */
